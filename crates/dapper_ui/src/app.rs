            ...
            egui::menu::bar(ui, |ui| {
                ui.menu_button("File", |ui| {
                    if ui.button("Open Workspace...").clicked() {
                        let _ = self.app_context.command_bus.try_dispatch(Command::LoadWorkspace {
